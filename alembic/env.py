...
# Use the Base metadata from our models
...
def run_migrations_offline() -> None:
    ...
    """
    # Get database URL from settings (supports environment variables)
    settings = get_settings()
    url = settings.DATABASE_URL

    # Override alembic.ini URL if not already set from config
